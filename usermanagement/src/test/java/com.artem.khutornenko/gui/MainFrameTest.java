...
import com.artem.khutornenko.db.MockDaoFactory;
...
public class MainFrameTest extends JFCTestCase {
	...
	protected void setUp() throws Exception {
		...
		try {
			...
			String lastName = "Khutornenko20";
			Date now = new Date(new Timestamp(2018, 11, 11, 0, 0, 0, 0).getTime());
